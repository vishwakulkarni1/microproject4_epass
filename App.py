...
account_sid = 'AC89202404e08e9f482421e889fd0d7849'
auth_token = '3d3370e082e6768c24d52d63b94aefbb'
...
def login_registration_dtls():
    ...
    if travel_pass < 30 and request.method == 'POST':
        ...
        client.messages.create(to="whatsapp:+918179823117",
                               from_="whatsapp:+19177462044",
                               body="Hello " + " " + full_name + " " + "Yours Travel From" + " " + source_dt + " " +
                                    "To" + " " + destination_dt + " "
